...
form.addEventListener("submit", function (event) {
    ...
    var HtmlResume = "\n    <form>\n    <h2><b>Editable Resume</b></h2>\n    <fieldset>\n\n    <legend>PERSONAL INFORMATION</legend>\n\n    <ul>\n    <li><u>Name:</u>  <span contenteditable=\"true\"> ".concat(name, "</span></li>\n    <li><u>Contact:</u>  <span contenteditable=\"true\"> ").concat(contactno, "</span></li>\n    <li><u>Email:</u>  <span contenteditable=\"true\"> ").concat(email, "</span></li>\n    <li><u>Date of Birth:</u>  <span contenteditable=\"true\"> ").concat(dob, "</span></li>\n    <li><u>Address:</u>  <span contenteditable=\"true\"> ").concat(address, "</span></li>\n    </ul>\n\n    </fieldset>\n\n    <fieldset>\n    \n    <legend>EDUCATION</legend>\n    <ul>\n        ").concat(educationData.map(function (edu) { return "<li>".concat(edu, "</li>"); }).join(""), "\n    </ul>\n\n    </fieldset>\n\n    </fieldset>\n\n    <fieldset>\n\n    <legend>EXPERIENCE</legend>\n    <ul>\n        ").concat(experienceData.map(function (exp) { return "<li>".concat(exp, "</li>"); }).join(""), "\n    </ul>\n    \n    </fieldset>\n\n    </fieldset>\n\n    <fieldset>\n\n    <legend>SKILLS</legend>\n    <ul>\n        ").concat(skillsData.map(function (skill) { return "<li>".concat(skill, "</li>"); }).join(""), "\n    </ul>\n\n    </fieldset>\n\n    </form>\n    ");
